...
if uploaded_file is not None: 
    ...
    # Create 3 columns display the 3 metrics
    col1, col2, col3 = st.columns(3)

    with col1:
        # Show the number of positive reviews and percentage
    ...
    with col2:
        # Show the number of neutral reviews and percentage
    ...
    with col3:
        # Show the number of negative reviews and percentage
